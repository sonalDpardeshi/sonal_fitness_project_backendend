...
//	Reset admin credetials
	@PostMapping("/reset")
	public String resetAdminCredentials(@RequestBody Admin admin) {
		boolean b=adminservice.resetAdminCredentials(admin);
		if(b) {
			
			return "admin credentials updates";
		}
		return "admin credentials not updates";
	}
